...
# new neo4j graph database. Change variables in "CHANGE HERE" to your graph database.
...
# CHANGE HERE: Create connection to graph database (Replace ??? with your Neo4j)
uri = "bolt://localhost:???"  # Local host link
user = "???"  # Username
password = "???"  # Password
driver = GraphDatabase.driver(uri, auth=(user, password))  # Neo4j driver
graph_name = "???"  # Name of the graph to appear in result evaluation section
...
algorithms = algorithm.dissertation(driver=driver, num_edges=[3,5,10])
